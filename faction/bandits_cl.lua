...
local blips = {
  ...
  {title="~p~Quartier costa_nostra", colour=83, id=84, x = 104.67, y = -1938.46, z = 20.8}
  }
  Citizen.CreateThread(function()
...
function OpenBanditsActionsMenu()
  ...
  if Config.EnablePlayerManagement and PlayerData.job2 ~= nil and PlayerData.job2.grade_name == 'consigliere' or PlayerData.job2.grade_name == 'righthand' or PlayerData.job2.grade_name == 'boss' then
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      if data.current.value == 'item' then
        TriggerServerEvent('esx_costa_nostra:buyItem')
      end

      if data.current.value == 'item1' then
        TriggerServerEvent('esx_costa_nostra:buyItem1')
      end

      if data.current.value == 'item2' then
        TriggerServerEvent('esx_costa_nostra:buyItem2')
      end
...
function OpenGetStocksBanditsMenu()
  ...
  ESX.TriggerServerCallback('esx_costa_nostra:getStockItemsBandits', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_costa_nostra:getStockItemsBandits', itemName, count)
            end
...
ESX.TriggerServerCallback('esx_costa_nostra:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_costa_nostra:putStockItemsBandits', itemName, count)
            end
  ...
  if Config.EnableArmoryManagement then
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('esx_costa_nostra:giveWeaponBandits', weapon,  1000)
      end,
      function(data, menu)
...
function OpenGetWeaponBanditsMenu(station)
  ...
  ESX.TriggerServerCallback('esx_costa_nostra:getArmoryWeaponsBandits', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_costa_nostra:removeArmoryWeaponBandits', function()
...
function OpenPutWeaponBanditsMenu(station)
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_costa_nostra:addArmoryWeaponBandits', function()
  ...
  ESX.TriggerServerCallback('esx_costa_nostra:getArmoryWeaponsBandits', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_costa_nostra:buyBandits', function(hasEnoughMoney)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        if data.current.value == 'formol' then
          menu.close()
          TriggerServerEvent('esx_costa_nostra:startHarvestBandits')
        end
      end,
      function(data, menu)
        menu.close()
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        if data.current.value == 'puce' then
          menu.close()
          TriggerServerEvent('esx_costa_nostra:startHarvest2Bandits')
        end
      end,
      function(data, menu)
        menu.close()
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value == 'spark' then
          menu.close()
          TriggerServerEvent('esx_costa_nostra:startHarvest3Bandits')
        end

        if data.current.value == 'tesla' then
          menu.close()
          TriggerServerEvent('esx_costa_nostra:startHarvest4Bandits')
        end
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        if data.current.value == 'sedatif' then
          menu.close()
          TriggerServerEvent('esx_costa_nostra:startCraftBandits')
        end

        if data.current.value == 'cryptedphone' then
          menu.close()
          TriggerServerEvent('esx_costa_nostra:startCraft2Bandits')
        end

        if data.current.value == 'lightbreak' then
          menu.close()
          TriggerServerEvent('esx_costa_nostra:startCraft3Bandits')
        end
...
AddEventHandler('esx_costa_nostra:hasEnteredMarkerBandits', function(zone, station, part, partNum)
...
AddEventHandler('esx_costa_nostra:hasExitedMarkerBandits', function(zone, station, part, partNum)

  if zone == 'HarvestBandits' then
    TriggerServerEvent('esx_costa_nostra:stopHarvestBandits')
  end

  if zone == 'HarvestBandits2' then
    TriggerServerEvent('esx_costa_nostra:stopHarvest2Bandits')
  end  

  if zone == 'HarvestBandits3' then
    TriggerServerEvent('esx_costa_nostra:stopHarvest3Bandits')
    TriggerServerEvent('esx_costa_nostra:stopHarvest4Bandits')
  end
  
  if zone == 'CraftBandits' then
    TriggerServerEvent('esx_costa_nostra:stopCraftBandits')
    TriggerServerEvent('esx_costa_nostra:stopCraft2Bandits')
    TriggerServerEvent('esx_costa_nostra:stopCraft3Bandits')
  end
...
Citizen.CreateThread(function()
  while true do
    ...
    if PlayerData.job2 ~= nil and PlayerData.job2.name == 'costa_nostra' then
  ...
  while true do
    ...
    if PlayerData.job2 ~= nil and PlayerData.job2.name == 'costa_nostra' then
      ...
      if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastZone ~= currentZone or LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum) ) then
        ...
        then
          TriggerEvent('esx_costa_nostra:hasExitedMarkerBandits', LastZone, LastStation, LastPart, LastPartNum)
          hasExited = true
        end
        ...
        TriggerEvent('esx_costa_nostra:hasEnteredMarkerBandits', currentZone, currentStation, currentPart, currentPartNum)
      end
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'costa_nostra' and (GetGameTimer() - GUI.Time) > 300 then

        if CurrentAction == 'bandits_actions_menu' then
          OpenBanditsActionsMenu()
        end

        -- if CurrentAction == 'bandits_harvest_menu' then
          -- OpenCryptedHarvestMenu()
        -- end

        -- if CurrentAction == 'bandits_harvest2_menu' then
          -- OpenCryptedHarvest2Menu()
        -- end

        --if CurrentAction == 'bandits_harvest3_menu' then
        --  OpenCryptedHarvest3Menu()
        --end        

        -- if CurrentAction == 'bandits_craft_menu' then
          -- OpenCryptedCraftMenu()
        -- end
...
AddEventHandler('esx_costa_nostra:teleportMarkers', function(position)
  ...
  -- while true do
    ...
    -- if PlayerData.job2 ~= nil and PlayerData.job2.name == 'costa_nostra' then
        ...
        -- if IsControlJustReleased(0, Keys["E"]) and isInPublicMarker then
          -- TriggerEvent('esx_costa_nostra:teleportMarkers', position)
        -- end
...
function OpenGetBlackMoney()
  ...
  ESX.TriggerServerCallback('esx_costa_nostra:getBlackMoneySociety', function(inventory)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        if data.current.type == 'item_weapon' then
          menu.close()
          TriggerServerEvent('esx_costa_nostra:getItem', data.current.type, data.current.value, data.current.ammo)
          ...
          ESX.UI.Menu.Open(
            ...
            function(data2, menu)
              ...
              if quantity == nil then
                ...
                menu.close()
                TriggerServerEvent('esx_costa_nostra:getItem', data.current.type, data.current.value, quantity)
                ESX.SetTimeout(300, function()
                  OpenGetBlackMoney()
                end)
              end
...
function OpenPutBlackMoney()
  ...
  ESX.TriggerServerCallback('esx_costa_nostra:getPlayerInventory2', function(inventory)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.type == 'item_weapon' then
          ...
          TriggerServerEvent('esx_costa_nostra:putItem', data.current.type, data.current.value, data.current.ammo)
          ...
          ESX.UI.Menu.Open(
            ...
            function(data2, menu)
              ...
              TriggerServerEvent('esx_costa_nostra:putItem', data.current.type, data.current.value, tonumber(data2.value))
